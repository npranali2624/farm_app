...
class SupplierVerification extends StatefulWidget {
  const SupplierVerification({super.key});

  @override
  State<SupplierVerification> createState() =>
      _SupplierVerificationState();
}

class _SupplierVerificationState extends State<SupplierVerification> {

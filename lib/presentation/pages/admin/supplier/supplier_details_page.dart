import 'package:farmer_app/presentation/pages/admin/supplier/supplier_verification.dart';
...
class SupplierDetailsPage extends StatelessWidget {
  ...
  const SupplierDetailsPage({super.key, required this.userId});
                ...
                onPressed: () async {
                  ...
                  if (result == true) {
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (_) => SupplierDetailsPage(userId: userId),
                      ),
                    );
                  }
                },
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const SupplierVerification(),
                    ),
                  );
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
